...
struct ADatasmithAreaLightActor : AActor {
	enum class EDatasmithAreaLightActorType LightType; // 0x240(0x01)
	enum class EDatasmithAreaLightActorShape LightShape; // 0x241(0x01)
	char pad_242[0x2]; // 0x242(0x02)
	struct FVector2D Dimensions; // 0x244(0x08)
	float Intensity; // 0x24c(0x04)
	enum class ELightUnits IntensityUnits; // 0x250(0x01)
	char pad_251[0x3]; // 0x251(0x03)
	struct FLinearColor Color; // 0x254(0x10)
	float Temperature; // 0x264(0x04)
	struct UTextureLightProfile* IESTexture; // 0x268(0x08)
	bool bUseIESBrightness; // 0x270(0x01)
	char pad_271[0x3]; // 0x271(0x03)
	float IESBrightnessScale; // 0x274(0x04)
	struct FRotator Rotation; // 0x278(0x0c)
	float SourceRadius; // 0x284(0x04)
	float SourceLength; // 0x288(0x04)
	float AttenuationRadius; // 0x28c(0x04)
	float SpotlightInnerAngle; // 0x290(0x04)
	float SpotlightOuterAngle; // 0x294(0x04)
};
...
struct UDatasmithContentBlueprintLibrary : UBlueprintFunctionLibrary {
	...
	struct FString GetDatasmithUserDataValueForKey(struct UObject* Object, struct FName Key); // Function DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserDataValueForKey // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x1061270
	void GetDatasmithUserDataKeysAndValuesForValue(struct UObject* Object, struct FString StringToMatch, struct TArray<struct FName> OutKeys, struct TArray<struct FString> OutValues); // Function DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserDataKeysAndValuesForValue // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x10610b0
	struct UDatasmithAssetUserData* GetDatasmithUserData(struct UObject* Object); // Function DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserData // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x1061020
};
...
struct ADatasmithImportedSequencesActor : AActor {
	struct TArray<struct ULevelSequence*> ImportedSequences; // 0x240(0x10)

	void PlayLevelSequence(struct ULevelSequence* SequenceToPlay); // Function DatasmithContent.DatasmithImportedSequencesActor.PlayLevelSequence // (Final|Native|Public|BlueprintCallable) // @ game+0x1061380
};
...
struct ADatasmithSceneActor : AActor {
	struct UDatasmithScene* Scene; // 0x240(0x08)
	struct TMap<struct FName, struct TSoftObjectPtr<struct AActor>> RelatedActors; // 0x248(0x50)
};
