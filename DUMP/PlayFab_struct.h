...
struct FExperimentationCreateExperimentRequest : FPlayFabRequestCommon {
	...
	enum class EExperimentType ExperimentType; // 0x24(0x01)
	char pad_25[0x3]; // 0x25(0x03)
	struct FString Name; // 0x28(0x10)
	struct FString SegmentId; // 0x38(0x10)
	struct FString StartDate; // 0x48(0x10)
	struct FString TitlePlayerAccountTestIds; // 0x58(0x10)
	struct TArray<struct UPlayFabJsonObject*> Variants; // 0x68(0x10)
};
...
struct FExperimentationUpdateExperimentRequest : FPlayFabRequestCommon {
	...
	struct FString SegmentId; // 0x48(0x10)
	struct FString StartDate; // 0x58(0x10)
	struct FString TitlePlayerAccountTestIds; // 0x68(0x10)
	struct TArray<struct UPlayFabJsonObject*> Variants; // 0x78(0x10)
};
...
struct FMultiplayerCreateBuildWithProcessBasedServerRequest : FPlayFabRequestCommon {
	...
	struct UPlayFabJsonObject* MetaData; // 0x60(0x08)
	int32_t MultiplayerServerCountPerVm; // 0x68(0x04)
	char pad_6C[0x4]; // 0x6c(0x04)
	struct FString OsPlatform; // 0x70(0x10)
	struct TArray<struct UPlayFabJsonObject*> Ports; // 0x80(0x10)
	struct TArray<struct UPlayFabJsonObject*> RegionConfigurations; // 0x90(0x10)
	struct FString StartMultiplayerServerCommand; // 0xa0(0x10)
	bool UseStreamingForAssetDownloads; // 0xb0(0x01)
	enum class EAzureVmSize VmSize; // 0xb1(0x01)
