...
// Enum Engine.EYDataTableEditorForce
enum class EYDataTableEditorForce : uint8 {
	None,
	UseYager,
	UseEpic,
	EYDataTableEditorForce_MAX,
};
...
struct FRepMovement {
	...
	char m_repAngularYawMovement; // 0x31(0x01)
	char pad_32[0x2]; // 0x32(0x02)
	float m_angularYawRotation; // 0x34(0x04)
	enum class EVectorQuantization LocationQuantizationLevel; // 0x38(0x01)
	enum class EVectorQuantization VelocityQuantizationLevel; // 0x39(0x01)
	enum class ERotatorQuantization RotationQuantizationLevel; // 0x3a(0x01)
...
struct FYAutonomousMoveData {
	struct FRotator m_pawnRotation; // 0x00(0x0c)
	struct FVector m_impulse; // 0x0c(0x0c)
	char m_replicatePawnRotation : 1; // 0x18(0x01)
	char m_wantBoost : 1; // 0x18(0x01)
	char m_wantClientAuthPosition : 1; // 0x18(0x01)
	char m_wantToApplyImpulse : 1; // 0x18(0x01)
	char m_assignClientLocationDirectly : 1; // 0x18(0x01)
	char m_savedWantsClimb : 1; // 0x18(0x01)
	char pad_18_6 : 2; // 0x18(0x01)
	char pad_19[0x3]; // 0x19(0x03)
	struct FVector m_savedClimbEndLocation; // 0x1c(0x0c)
	struct FVector m_savedClimbStartLocation; // 0x28(0x0c)
	float m_savedClimbTimer; // 0x34(0x04)
	float m_savedClimbingSpeed; // 0x38(0x04)
	char m_savedClimbMoveType; // 0x3c(0x01)
	char pad_3D[0x3]; // 0x3d(0x03)
	float m_savedLeanAngle; // 0x40(0x04)
	char m_savedLeanTarget; // 0x44(0x01)
...
struct FYChartResultData {
	int32_t m_framesCollected; // 0x00(0x04)
	float m_secondSpent; // 0x04(0x04)
	float m_secondsDisregarded; // 0x08(0x04)
	float m_averageFps; // 0x0c(0x04)
	float m_percentMissedVsyncsThirty; // 0x10(0x04)
	float m_percentMissedVsyncsSixty; // 0x14(0x04)
	float m_averageGameTime; // 0x18(0x04)
	float m_minGameTime; // 0x1c(0x04)
	float m_maxGameTime; // 0x20(0x04)
	float m_averageDrawTime; // 0x24(0x04)
	float m_minDrawTime; // 0x28(0x04)
	float m_maxDrawTime; // 0x2c(0x04)
	float m_averageGpuTime; // 0x30(0x04)
	float m_minGpuTime; // 0x34(0x04)
	float m_maxGpuTime; // 0x38(0x04)
	float m_boundGameThreadPercent; // 0x3c(0x04)
	float m_boundRenderThreadPercent; // 0x40(0x04)
	float m_boundGPUThreadPercent; // 0x44(0x04)
	float m_maxFps; // 0x48(0x04)
	float m_minFps; // 0x4c(0x04)
};
...
struct FLevelSimplificationDetails {
	...
	float m_minSquaredBounds; // 0x08(0x04)
	struct FMaterialProxySettings StaticMeshMaterialSettings; // 0x0c(0x88)
	bool bOverrideLandscapeExportLOD; // 0x94(0x01)
	char pad_95[0x3]; // 0x95(0x03)
	int32_t LandscapeExportLOD; // 0x98(0x04)
	struct FMaterialProxySettings LandscapeMaterialSettings; // 0x9c(0x88)
	bool bBakeFoliageToLandscape; // 0x124(0x01)
	bool bBakeGrassToLandscape; // 0x125(0x01)
	bool bGenerateMeshNormalMap; // 0x126(0x01)
	bool bGenerateMeshMetallicMap; // 0x127(0x01)
	bool bGenerateMeshRoughnessMap; // 0x128(0x01)
	bool bGenerateMeshSpecularMap; // 0x129(0x01)
	bool bGenerateLandscapeNormalMap; // 0x12a(0x01)
	bool bGenerateLandscapeMetallicMap; // 0x12b(0x01)
	bool bGenerateLandscapeRoughnessMap; // 0x12c(0x01)
	bool bGenerateLandscapeSpecularMap; // 0x12d(0x01)
