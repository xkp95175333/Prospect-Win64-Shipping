...
struct FAnimNode_SequenceEvaluator : FAnimNode_AssetPlayerBase {
	...
	float NormalizedTime; // 0x44(0x04)
	bool bShouldLoop; // 0x48(0x01)
	bool bTeleportToExplicitTime; // 0x49(0x01)
	enum class ESequenceEvalReinit ReinitializationBehavior; // 0x4a(0x01)
