...
struct AControlPointMeshActor : AActor {
	struct UControlPointMeshComponent* ControlPointMeshComponent; // 0x240(0x08)
};
...
// Size: 0x5b8 (Inherited: 0x240)
struct ALandscapeProxy : AActor {
	struct ULandscapeSplinesComponent* SplineComponent; // 0x240(0x08)
	struct FGuid LandscapeGuid; // 0x248(0x10)
	struct FIntPoint LandscapeSectionOffset; // 0x258(0x08)
	int32_t MaxLODLevel; // 0x260(0x04)
	float LODDistanceFactor; // 0x264(0x04)
	enum class ELandscapeLODFalloff LODFalloff; // 0x268(0x01)
	char pad_269[0x3]; // 0x269(0x03)
	float ComponentScreenSizeToUseSubSections; // 0x26c(0x04)
	float LOD0ScreenSize; // 0x270(0x04)
	float LOD0DistributionSetting; // 0x274(0x04)
	float LODDistributionSetting; // 0x278(0x04)
	float TessellationComponentScreenSize; // 0x27c(0x04)
	bool UseTessellationComponentScreenSizeFalloff; // 0x280(0x01)
	char pad_281[0x3]; // 0x281(0x03)
	float TessellationComponentScreenSizeFalloff; // 0x284(0x04)
	int32_t OccluderGeometryLOD; // 0x288(0x04)
	int32_t StaticLightingLOD; // 0x28c(0x04)
	struct UPhysicalMaterial* DefaultPhysMaterial; // 0x290(0x08)
	float StreamingDistanceMultiplier; // 0x298(0x04)
	char pad_29C[0x4]; // 0x29c(0x04)
	struct UMaterialInterface* LandscapeMaterial; // 0x2a0(0x08)
	char pad_2A8[0x20]; // 0x2a8(0x20)
	struct UMaterialInterface* LandscapeHoleMaterial; // 0x2c8(0x08)
	struct TArray<struct FLandscapeProxyMaterialOverride> LandscapeMaterialsOverride; // 0x2d0(0x10)
	bool bMeshHoles; // 0x2e0(0x01)
	char MeshHolesMaxLod; // 0x2e1(0x01)
	char pad_2E2[0x6]; // 0x2e2(0x06)
	struct TArray<struct URuntimeVirtualTexture*> RuntimeVirtualTextures; // 0x2e8(0x10)
	int32_t VirtualTextureNumLods; // 0x2f8(0x04)
	int32_t VirtualTextureLodBias; // 0x2fc(0x04)
	enum class ERuntimeVirtualTextureMainPassType VirtualTextureRenderPassType; // 0x300(0x01)
	char pad_301[0x3]; // 0x301(0x03)
	float NegativeZBoundsExtension; // 0x304(0x04)
	float PositiveZBoundsExtension; // 0x308(0x04)
	char pad_30C[0x4]; // 0x30c(0x04)
	struct TArray<struct ULandscapeComponent*> LandscapeComponents; // 0x310(0x10)
	struct TArray<struct ULandscapeHeightfieldCollisionComponent*> CollisionComponents; // 0x320(0x10)
	struct TArray<struct UHierarchicalInstancedStaticMeshComponent*> FoliageComponents; // 0x330(0x10)
	char pad_340[0x64]; // 0x340(0x64)
	bool bHasLandscapeGrass; // 0x3a4(0x01)
	char pad_3A5[0x3]; // 0x3a5(0x03)
	float StaticLightingResolution; // 0x3a8(0x04)
	char CastShadow : 1; // 0x3ac(0x01)
	char bCastDynamicShadow : 1; // 0x3ac(0x01)
	char bCastStaticShadow : 1; // 0x3ac(0x01)
	char pad_3AC_3 : 5; // 0x3ac(0x01)
	char pad_3AD[0x3]; // 0x3ad(0x03)
	char bCastFarShadow : 1; // 0x3b0(0x01)
	char pad_3B0_1 : 7; // 0x3b0(0x01)
	char pad_3B1[0x3]; // 0x3b1(0x03)
	char bCastHiddenShadow : 1; // 0x3b4(0x01)
	char pad_3B4_1 : 7; // 0x3b4(0x01)
	char pad_3B5[0x3]; // 0x3b5(0x03)
	char bCastShadowAsTwoSided : 1; // 0x3b8(0x01)
	char pad_3B8_1 : 7; // 0x3b8(0x01)
	char pad_3B9[0x3]; // 0x3b9(0x03)
	char bAffectDistanceFieldLighting : 1; // 0x3bc(0x01)
	char pad_3BC_1 : 7; // 0x3bc(0x01)
	struct FLightingChannels LightingChannels; // 0x3bd(0x01)
	char pad_3BE[0x2]; // 0x3be(0x02)
	char bUseMaterialPositionOffsetInStaticLighting : 1; // 0x3c0(0x01)
	char bRenderCustomDepth : 1; // 0x3c0(0x01)
	char pad_3C0_2 : 6; // 0x3c0(0x01)
	char pad_3C1[0x3]; // 0x3c1(0x03)
	enum class ERendererStencilMask CustomDepthStencilWriteMask; // 0x3c4(0x01)
	...
	struct FBodyInstance BodyInstance; // 0x3f8(0x158)
	char bGenerateOverlapEvents : 1; // 0x550(0x01)
	char bBakeMaterialPositionOffsetIntoCollision : 1; // 0x550(0x01)
	char pad_550_2 : 6; // 0x550(0x01)
	char pad_551[0x3]; // 0x551(0x03)
	int32_t ComponentSizeQuads; // 0x554(0x04)
	int32_t SubsectionSizeQuads; // 0x558(0x04)
	int32_t NumSubsections; // 0x55c(0x04)
	char bUsedForNavigation : 1; // 0x560(0x01)
	char bFillCollisionUnderLandscapeForNavmesh : 1; // 0x560(0x01)
	char pad_560_2 : 6; // 0x560(0x01)
	char pad_561[0x3]; // 0x561(0x03)
	bool bUseDynamicMaterialInstance; // 0x564(0x01)
	enum class ENavDataGatheringMode NavigationGeometryGatheringMode; // 0x565(0x01)
	bool bUseLandscapeForCullingInvisibleHLODVertices; // 0x566(0x01)
	bool bHasLayersContent; // 0x567(0x01)
	struct TMap<struct UTexture2D*, struct ULandscapeWeightmapUsage*> WeightmapUsageMap; // 0x568(0x50)

	void SetLandscapeMaterialVectorParameterValue(struct FName ParameterName, struct FLinearColor Value); // Function Landscape.LandscapeProxy.SetLandscapeMaterialVectorParameterValue // (Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x2c40bc0
	void SetLandscapeMaterialTextureParameterValue(struct FName ParameterName, struct UTexture* Value); // Function Landscape.LandscapeProxy.SetLandscapeMaterialTextureParameterValue // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x2c40af0
	void SetLandscapeMaterialScalarParameterValue(struct FName ParameterName, float Value); // Function Landscape.LandscapeProxy.SetLandscapeMaterialScalarParameterValue // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x2c40a20
	bool LandscapeExportHeightmapToRenderTarget(struct UTextureRenderTarget2D* InRenderTarget, bool InExportHeightIntoRGChannel, bool InExportLandscapeProxies); // Function Landscape.LandscapeProxy.LandscapeExportHeightmapToRenderTarget // (Final|Native|Public|BlueprintCallable) // @ game+0x2c40900
	void EditorSetLandscapeMaterial(struct UMaterialInterface* NewLandscapeMaterial); // Function Landscape.LandscapeProxy.EditorSetLandscapeMaterial // (Final|Native|Public|BlueprintCallable) // @ game+0x1a7f650
	void EditorApplySpline(struct USplineComponent* InSplineComponent, float StartWidth, float EndWidth, float StartSideFalloff, float EndSideFalloff, float StartRoll, float EndRoll, int32_t NumSubdivisions, bool bRaiseHeights, bool bLowerHeights, struct ULandscapeLayerInfoObject* PaintLayer, struct FName EditLayerName); // Function Landscape.LandscapeProxy.EditorApplySpline // (Final|Native|Public|BlueprintCallable) // @ game+0x2c40570
	void ChangeUseTessellationComponentScreenSizeFalloff(bool InComponentScreenSizeToUseSubSections); // Function Landscape.LandscapeProxy.ChangeUseTessellationComponentScreenSizeFalloff // (Native|Public|BlueprintCallable) // @ game+0x2c404e0
	void ChangeTessellationComponentScreenSizeFalloff(float InUseTessellationComponentScreenSizeFalloff); // Function Landscape.LandscapeProxy.ChangeTessellationComponentScreenSizeFalloff // (Native|Public|BlueprintCallable) // @ game+0x2c40450
	void ChangeTessellationComponentScreenSize(float InTessellationComponentScreenSize); // Function Landscape.LandscapeProxy.ChangeTessellationComponentScreenSize // (Native|Public|BlueprintCallable) // @ game+0x2c403c0
	void ChangeLODDistanceFactor(float InLODDistanceFactor); // Function Landscape.LandscapeProxy.ChangeLODDistanceFactor // (Native|Public|BlueprintCallable) // @ game+0x2c40330
	void ChangeComponentScreenSizeToUseSubSections(float InComponentScreenSizeToUseSubSections); // Function Landscape.LandscapeProxy.ChangeComponentScreenSizeToUseSubSections // (Native|Public|BlueprintCallable) // @ game+0x2c402a0
};
...
struct ALandscapeBlueprintBrushBase : AActor {
	...
	void RequestLandscapeUpdate(); // Function Landscape.LandscapeBlueprintBrushBase.RequestLandscapeUpdate // (Final|Native|Public|BlueprintCallable) // @ game+0xfa96f0
	struct UTextureRenderTarget2D* Render(bool InIsHeightmap, struct UTextureRenderTarget2D* InCombinedResult, struct FName InWeightmapLayerName); // Function Landscape.LandscapeBlueprintBrushBase.Render // (Native|Event|Public|HasOutParms|BlueprintEvent) // @ game+0x2c3ed60
	void Initialize(struct FTransform InLandscapeTransform, struct FIntPoint InLandscapeSize, struct FIntPoint InLandscapeRenderTargetSize); // Function Landscape.LandscapeBlueprintBrushBase.Initialize // (Native|Event|Public|HasOutParms|HasDefaults|BlueprintEvent) // @ game+0x2c3ebe0
	void GetBlueprintRenderDependencies(struct TArray<struct UObject*> OutStreamableAssets); // Function Landscape.LandscapeBlueprintBrushBase.GetBlueprintRenderDependencies // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0x1e02480
};
...
struct ULandscapeComponent : UPrimitiveComponent {
	...
	struct UMaterialInstanceDynamic* GetMaterialInstanceDynamic(int32_t InIndex); // Function Landscape.LandscapeComponent.GetMaterialInstanceDynamic // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2c3eb10
	float EditorGetPaintLayerWeightByNameAtLocation(struct FVector InLocation, struct FName InPaintLayerName); // Function Landscape.LandscapeComponent.EditorGetPaintLayerWeightByNameAtLocation // (Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x2c3ea30
	float EditorGetPaintLayerWeightAtLocation(struct FVector InLocation, struct ULandscapeLayerInfoObject* PaintLayer); // Function Landscape.LandscapeComponent.EditorGetPaintLayerWeightAtLocation // (Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x2c3e950
};
...
struct ULandscapeHeightfieldCollisionComponent : UPrimitiveComponent {
	...
	struct ULandscapeComponent* GetRenderComponent(); // Function Landscape.LandscapeHeightfieldCollisionComponent.GetRenderComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2c3ebb0
};
...
struct ULandscapeMaterialInstanceConstant : UMaterialInstanceConstant {
	struct TArray<struct FLandscapeMaterialTextureStreamingInfo> TextureStreamingInfo; // 0x370(0x10)
	char bIsLayerThumbnail : 1; // 0x380(0x01)
	char bDisableTessellation : 1; // 0x380(0x01)
	char bMobile : 1; // 0x380(0x01)
	char bEditorToolUsage : 1; // 0x380(0x01)
...
struct ALandscapeMeshProxyActor : AActor {
	struct ULandscapeMeshProxyComponent* LandscapeMeshProxyComponent; // 0x240(0x08)
};
...
struct ULandscapeSplinesComponent : UPrimitiveComponent {
	...
	struct TArray<struct USplineMeshComponent*> GetSplineMeshComponents(); // Function Landscape.LandscapeSplinesComponent.GetSplineMeshComponents // (Final|Native|Public|BlueprintCallable) // @ game+0x2c427c0
};
...
struct ALandscapeStreamingProxy : ALandscapeProxy {
	LazyObjectProperty LandscapeActor; // 0x5b8(0x1c)
