...
struct UBaseBrushTool : UMeshSurfacePointTool {
	...
	SoftClassProperty PropertyClass; // 0x190(0x28)
...
struct UGizmoBaseComponent : UPrimitiveComponent {
	...
	void UpdateWorldLocalState(bool bWorldIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateWorldLocalState // (Final|Native|Public) // @ game+0x3c45080
	void UpdateHoverState(bool bHoveringIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateHoverState // (Final|Native|Public) // @ game+0x3c44ff0
};
...
struct UGizmoTransformSource : UInterface {
	...
	void SetTransform(struct FTransform NewTransform); // Function InteractiveToolsFramework.GizmoTransformSource.SetTransform // (Native|Public|HasOutParms|HasDefaults) // @ game+0x3c44e80
	struct FTransform GetTransform(); // Function InteractiveToolsFramework.GizmoTransformSource.GetTransform // (Native|Public|HasDefaults|Const) // @ game+0x3c44cf0
};
...
struct UGizmoAxisSource : UInterface {
	...
	bool HasTangentVectors(); // Function InteractiveToolsFramework.GizmoAxisSource.HasTangentVectors // (Native|Public|Const) // @ game+0x194cfb0
	void GetTangentVectors(struct FVector TangentXOut, struct FVector TangentYOut); // Function InteractiveToolsFramework.GizmoAxisSource.GetTangentVectors // (Native|Public|HasOutParms|HasDefaults|Const) // @ game+0x3c44c00
	struct FVector GetOrigin(); // Function InteractiveToolsFramework.GizmoAxisSource.GetOrigin // (Native|Public|HasDefaults|Const) // @ game+0x3c44b50
	struct FVector GetDirection(); // Function InteractiveToolsFramework.GizmoAxisSource.GetDirection // (Native|Public|HasDefaults|Const) // @ game+0x3c44b10
};
...
struct UGizmoClickTarget : UInterface {
	...
	void UpdateHoverState(bool bHovering); // Function InteractiveToolsFramework.GizmoClickTarget.UpdateHoverState // (Native|Public|Const) // @ game+0x3c44f60
};
...
struct UGizmoStateTarget : UInterface {
	...
	void EndUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.EndUpdate // (Native|Public) // @ game+0x194ced0
	void BeginUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.BeginUpdate // (Native|Public) // @ game+0x3c44ad0
};
...
struct UGizmoFloatParameterSource : UInterface {
	...
	void SetParameter(float NewValue); // Function InteractiveToolsFramework.GizmoFloatParameterSource.SetParameter // (Native|Public) // @ game+0x3c44d60
	float GetParameter(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.GetParameter // (Native|Public|Const) // @ game+0x3c44b90
	void EndModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.EndModify // (Native|Public) // @ game+0x3c44af0
	void BeginModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.BeginModify // (Native|Public) // @ game+0x194ced0
};
...
struct UGizmoVec2ParameterSource : UInterface {
	...
	void SetParameter(struct FVector2D NewValue); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.SetParameter // (Native|Public|HasOutParms|HasDefaults) // @ game+0x3c44df0
	struct FVector2D GetParameter(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.GetParameter // (Native|Public|HasDefaults|Const) // @ game+0x3c44bc0
	void EndModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.EndModify // (Native|Public) // @ game+0x3c44af0
	void BeginModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.BeginModify // (Native|Public) // @ game+0x194ced0
};
...
struct AIntervalGizmoActor : AGizmoActor {
	struct UGizmoLineHandleComponent* UpIntervalComponent; // 0x240(0x08)
	struct UGizmoLineHandleComponent* DownIntervalComponent; // 0x248(0x08)
	struct UGizmoLineHandleComponent* ForwardIntervalComponent; // 0x250(0x08)
};
...
struct ATransformGizmoActor : AGizmoActor {
	struct UPrimitiveComponent* TranslateX; // 0x240(0x08)
	struct UPrimitiveComponent* TranslateY; // 0x248(0x08)
	struct UPrimitiveComponent* TranslateZ; // 0x250(0x08)
	struct UPrimitiveComponent* TranslateYZ; // 0x258(0x08)
	struct UPrimitiveComponent* TranslateXZ; // 0x260(0x08)
	struct UPrimitiveComponent* TranslateXY; // 0x268(0x08)
	struct UPrimitiveComponent* RotateX; // 0x270(0x08)
	struct UPrimitiveComponent* RotateY; // 0x278(0x08)
	struct UPrimitiveComponent* RotateZ; // 0x280(0x08)
	struct UPrimitiveComponent* UniformScale; // 0x288(0x08)
	struct UPrimitiveComponent* AxisScaleX; // 0x290(0x08)
	struct UPrimitiveComponent* AxisScaleY; // 0x298(0x08)
	struct UPrimitiveComponent* AxisScaleZ; // 0x2a0(0x08)
	struct UPrimitiveComponent* PlaneScaleYZ; // 0x2a8(0x08)
	struct UPrimitiveComponent* PlaneScaleXZ; // 0x2b0(0x08)
	struct UPrimitiveComponent* PlaneScaleXY; // 0x2b8(0x08)
};
